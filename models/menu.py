...
if gpart and authstat and not gpart.game_part.banned:
    ...
    if gpart.game_part.squad_id:
        ...
        if not gpart.game_part.squad_leader:
            response.squadmenu = [
                LI(A('Squad ',UL(
                LI(A('Squad HQ', _href=URL('gamectrl', 'squadhq', args=gpart.game_part.squad_id), _class=''),
        ...
        # squad leader menu
            ...
            response.squadmenu = [
                LI(A('Squad ',UL(
                LI(A('Squad HQ', _href=URL('gamectrl', 'squadhq', args=gpart.game_part.squad_id), _class='')),
                LI(A('Manage Squad', _href=URL('gamectrl', 'squadadmin', args=gpart.game_part.squad_id), _class=''),
                _class=''),_class='dropdown-menu', _id='gamemenu'),
                _href="#", _class="dropdown-toggle", **{'_data-toggle':'dropdown'}),_class='dropdown')
                ]
# Menu if banned
