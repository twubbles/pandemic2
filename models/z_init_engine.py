...
#     db.creature_type.insert(cid=3, zombie=True, name="Original Zombie", immortal=True,hidden=False)
#     db.creature_type.insert(cid=4, zombie=False, name="Admin Player", immortal=False,hidden=False)
